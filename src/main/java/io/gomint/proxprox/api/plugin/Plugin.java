...
public class Plugin {
     ...
     * Meta of this plugin
     */
    @Getter @Setter PluginMeta meta;

    /**
     * Logger for this Plugin
     */
    @Getter @Setter Logger logger;

    /**
     * Scheduler for this Plugin
     */
    @Getter @Setter Scheduler scheduler;
    ...
    public final File getDataFolder() {
        return new File( getPluginManager().getBaseDirectory(), getMeta().getName() );
    }
