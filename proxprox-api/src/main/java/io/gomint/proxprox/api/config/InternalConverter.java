...
import io.gomint.proxprox.api.config.converter.Converter;
import io.gomint.proxprox.api.config.converter.PrimitiveConverter;
...
public class InternalConverter {
    ...
    public InternalConverter( BaseConfig config ) {
        ...
        try {
            ...
            addConverter( io.gomint.proxprox.api.config.converter.ConfigConverter.class );
            addConverter( io.gomint.proxprox.api.config.converter.ListConverter.class );
            addConverter( io.gomint.proxprox.api.config.converter.MapConverter.class );
            addConverter( io.gomint.proxprox.api.config.converter.ArrayConverter.class );
            addConverter( io.gomint.proxprox.api.config.converter.SetConverter.class );
